...
Route::post('questions/{question}/question/{vote}', 'VotesController@voteQuestion')->name('questions.vote');
Route::post('answers/{answer}/answer/{vote}', 'VotesController@VoteAnswer')->name('answers.vote');
